...
namespace NodeGraph.Editor
{
    public class BaseEdgeDragHelper : EdgeDragHelper
    {
        ...
        public const int k_PanAreaWidth = 30;
        public const int k_PanSpeed = 4;
        public const int k_PanInterval = 10;
        public const float k_MinSpeedFactor = 0.5f;
        public const float k_MaxSpeedFactor = 7f;
        public const float k_MaxPanSpeed = k_MaxSpeedFactor * k_PanSpeed;
        public const float kPortDetectionWidth = 30;

        protected Dictionary<NodeView, List<PortView>> compatiblePorts = new Dictionary<NodeView, List<PortView>>();
        ...
        public BaseEdgeDragHelper(NodeGraphView graphView)
        {
            this.listener = new BaseEdgeConnectorListener(graphView);
        ...
        public override bool HandleMouseDown(MouseDownEvent evt)
        {
            ...
            {
                compatiblePorts.TryGetValue(port.node as NodeView, out var portList);
                if (portList == null)
                    portList = compatiblePorts[port.node as NodeView] = new List<PortView>();
                portList.Add(port);
            }
        ...
        public Vector2 GetEffectivePanSpeed(Vector2 mousePos)
        {
        ...
        Rect GetPortBounds(NodeView nodeView, int index, List<PortView> portList)
        {
